...
When trying to work with ObjectRef (or Object Tables), you will need to create (or reuse) some resource connection that has permissions to work with the bucket your files are in.
